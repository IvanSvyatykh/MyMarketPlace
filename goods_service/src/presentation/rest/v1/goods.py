...
from ..schemas.goods import GetGoodsResponse, AddGoodRequest, AddGoodPhotosRequest
...
async def add_photos_to_good(request: AddGoodPhotosRequest, files: list[UploadFile] = File(...)) -> None:
